...
[_GAMING] = LAYOUT_preonic_grid( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,  \
  KC_LCTL, BACKLIT, KC_NO,   KC_LALT, LOWER_GAME,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
 ...
 * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|AudOff|AGnorm|AGswap|Qwerty|Colemk|Dvorak|Gaming|      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  GAMING,  _______, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
        ...
        case LOWER_GAME:
          if (record->event.pressed) {
            layer_on(_LOWER_GAME);
            update_tri_layer(_LOWER_GAME, _RAISE, _ADJUST);
          } else {
            layer_off(_LOWER_GAME);
            update_tri_layer(_LOWER_GAME, _RAISE, _ADJUST);
          }
          return false;
          break;
